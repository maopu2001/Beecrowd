...
void solve()
{
  ...
  m.insert({11, "Sao Paulo"});
  m.insert({61, "Brasilia"});
  m.insert({71, "Salvador"});
  m.insert({21, "Rio de Janeiro"});
  m.insert({32, "Juiz de Fora"});
  m.insert({19, "Campinas"});
  m.insert({27, "Vitoria"});
  m.insert({31, "Belo Horizonte"});
