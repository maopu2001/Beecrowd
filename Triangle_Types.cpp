...
void solve()
{
  ...
  if (A >= B + C)
    cout << "NAO FORMA TRIANGULO" << nl;
  else
  {
    if (A * A == B * B + C * C)
      cout << "TRIANGULO RETANGULO" << nl;
    else if (A * A > B * B + C * C)
      cout << "TRIANGULO OBTUSANGULO" << nl;
    else
      cout << "TRIANGULO ACUTANGULO" << nl;
    if (A == B && B == C)
      cout << "TRIANGULO EQUILATERO" << nl;
    else if (A == B || B == C || C == A)
      cout << "TRIANGULO ISOSCELES" << nl;
  }
}
